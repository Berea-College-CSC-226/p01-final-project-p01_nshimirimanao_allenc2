...
**Google Doc Link**: Google Doc in other branch
...
**Purpose**: `A classic game of snake where you try to eat apples without touching the body.`
...
![Don't leave me in your README!](https://docs.google.com/document/d/1BvdCuQTfPH5omY4bG-m5JHoShL1dy_Q6IjuQnyrNBgo/edit?usp=sharing)
...
```
    ...
    Branch 2 starting name: allenc2
```
